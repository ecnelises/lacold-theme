    ...
    class IntelliJ < Base
      ...
      def intellij_theme(theme)
        attrs = [
          ...
          attribute("DEFAULT_KEYWORD", foreground: theme.primary, font_type: 1),
          attribute("DEFAULT_STRING", foreground: theme.fg),
          attribute("DEFAULT_NUMBER", foreground: theme.accent_secondary),
          attribute("DEFAULT_FUNCTION_DECLARATION", foreground: theme.fg, font_type: 1),
          attribute("DEFAULT_CLASS_NAME", foreground: theme.accent_secondary),
